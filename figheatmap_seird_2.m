...
hold on
[tmpc,tmph]=contour(beta_vec,p_vec,flipud(qval),[0.02 0.05 0.1:0.1:0.9]);
clabel(tmpc,tmph);
...
title({'Relevance of asymptomatic cases, $q$';'$T_s=10$ days and $T_a=5$ days'},'fontsize',20,'interpreter','latex')
