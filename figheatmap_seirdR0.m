...
hold on
[tmpc,tmph]=contour(beta_vec,p_vec,flipud(R0),[3.0:0.25:6]);
clabel(tmpc,tmph);
...
title({'Basic reproduction number ${\cal{R}}_0$';'$T_s=10$ days and $T_a=20$ days'},'fontsize',20,'interpreter','latex')
